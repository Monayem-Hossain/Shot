...
██║  ██║██╔══╝  ╚██╗ ██╔╝██║██║     
██████╔╝███████╗ ╚████╔╝ ██║███████╗
╚═════╝ ╚══════╝  ╚═══╝  ╚═╝╚══════╝\n\t\t\033[1;36m MONAYEM-HOSSAIN  \n\t\t[\033[1;32m*\033[1;37m] NAME        : MONAYEM HOSSAIN\n\t\t[\033[1;32m*\033[1;37m] WORK ONLY   : GREEN-COLOR WIFI\n\t\t[\033[1;32m*\033[1;37m] AUTHOR      : Unknown \n\t\t[\033[1;32m*\033[1;37m] Version     : Shot2.0 \n\t\t[\033[1;32m*\033[1;37m] FACEBOOK    : @monayem.hossaon.01 \n''')
...
def usage():
    return """
SHOT 0.0.2 (c) 2017 rofl0r (modified).
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='ShotPin 0.0.2 (c) 2017 rofl0r (modified).',
        ...
        try:
            ...
            if args.loop:
                if input("\n[?] Exit the script (otherwise continue to AP scan)? [N/y] ").lower() == 'y':
                    ani("\n[\033[1;31m!\033[1;37m] Create by Monayem-Hossain.🐸😁…")
                    break
                else:
                    args.bssid = None
            else:
